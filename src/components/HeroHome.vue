<template>
  <section class="hero-main">
    <div class="hero-content-container">
      ...
      <div class="hero-started-container">
        ...
        <button>
          get started
          <v-icon name="co-chevron-right" fill="white" />
        </button>
      </div>
      <!-- <GetStarted /> -->
      <div class="hero-teaser-container">
        ...
        <div class="hero-teaser-sub-container">
...
.hero-main
  max-height: 120vh
  background-image: linear-gradient(to top, rgba(0, 0, 0, 0.8) 0, rgba(0, 0, 0, 0) 60%, rgba(0, 0, 0, 0.8) 100%),linear-gradient(to top, rgba(0, 0, 0, 0.8) 0, rgba(0, 0, 0, 0) 60%, rgba(0, 0, 0, 0.8) 100%),linear-gradient(to top , rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.3) 100%), url('../../public/hero-bg.jpeg')
...
@media (max-width: 967px)
  .hero-main
    max-height: 90vh
    background-image: linear-gradient(to top, rgba(0, 0, 0, 0.8) 0, rgba(0, 0, 0, 0) 80%, rgba(0, 0, 0, 0.8) 100%),linear-gradient(to top, rgba(0, 0, 0, 0.8) 0, rgba(0, 0, 0, 0) 80%, rgba(0, 0, 0, 0.8) 100%),linear-gradient(to top , rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.3) 100%), url('../../public/hero-bg.jpeg')
